...
export default {
  ...
  theme: {
    extend: {
      ...
      rotate: { 1.5: "1.5deg", 2.5: "2.5deg", 3.5: "3.5deg", 5: "5deg", 8: "8deg", 12: "12deg" },
      boxShadow: {
      ...
      keyframes: {
        ...
        jitter: { "0%,100%": { transform: "translate(0,0)" }, "50%": { transform: "translate(1px,-1px)" } },
        float: { "0%,100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-4px)" } },
        pulsebg: { "0%,100%": { opacity: .1 }, "50%": { opacity: .25 } }
      },
      animation: {
